...
window.addEventListener('load', function() {
    if (document.getElementById("editor-wysiwyg")) {
    //get data id post
    const editorElement = document.querySelector('#editor-wysiwyg');
    //memasukkan data post ke content 
    const setContentPost = editorElement.getAttribute('data-content') || '<p>Start editing...</p>';
    const editorDiv = document.querySelector('#editor-wysiwyg');
    const hiddenInput = document.querySelector('#editor-content');

    // Sinkronkan data saat ada perubahan di editor
    editorDiv.addEventListener('input', function () {
        hiddenInput.value = editorDiv.innerHTML; // Salin isi editor ke input hidden
    });

    editorDiv.addEventListener('blur', function () {
        hiddenInput.value = editorDiv.innerHTML; // Sinkronkan hanya saat editor kehilangan fokus
    });

    // Pastikan data tersinkronkan sebelum formulir dikirim
    ...
    const editor = new Editor({
        element: document.querySelector('#editor-wysiwyg'),
        extensions: [
        ...
        // content: window.postContent || '<p>Start editing...</p>', //isi post //jika menggunakan js di content blade editor
        content: setContentPost, //isi post
        editorProps: {
            attributes: {
