<x-layout>
    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-18 lg:px-6">
        ...
        <div class="py-4 {{-- px-4 --}} mx-auto max-w-screen-xl lg:py-8 {{-- lg:px-6--}}">
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                @forelse ($posts as $post)                    
                    <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 hover:border-gray-900 hover:bg-gray-200">
                        ...
                        <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a href="/posts/{{ $post->slug }}" class="hover:underline hover:text-primary-900">{{ $post->title }}</a>
                        </h2>
