...
<div class="text-center">
    <button class="fixed bottom-5 left-5 p-3 px-4 text-sm bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 focus:outline-none " type="button" data-drawer-target="drawer-contact" data-drawer-show="drawer-contact" aria-controls="drawer-contact">
        Show contact form
    </button>
</div>