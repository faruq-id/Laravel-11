      ...
      <div class="w-full p-3 lg:px-5 lg:pl-3">
         <div class="flex items-center justify-between">
            <div class="flex items-center">
               <button @click="openSidebar = !openSidebar" title="Dekstop" class="lg:!block hidden mr-3 p-2 cursor-pointer rounded text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                  <!-- Ikon Hamburger -->
               ...
               <a href="/dashboard" class="flex items-center">
                  <img src="img/logo.png" class="mr-3 h-6 sm:h-8" alt="SIAKAD Logo" />
