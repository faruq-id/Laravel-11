                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('auth.register.proses') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="w-full sm:flex-1 mt-3 sm:mt-0">
                            ...
                            dark:bg-gray-700 rounded-md shadow-md border border-gray-300
                              ...
                              @error('profile_picture') border-red-600 focus:ring-red-600 focus:border-red-600 dark:border dark:border-red-500 @enderror">
                              <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 @error('profile_picture') text-red-600 dark:text-red-500 @enderror" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
                                  d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                              </svg>
                    
                              <div class="ml-1 flex flex-col @error('profile_picture') text-red-600 dark:text-red-500 @enderror">
