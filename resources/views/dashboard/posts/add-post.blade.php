<x-dashboard-layout>
    ...
    <div class="grid grid-cols-1 gap-y-6 dark:bg-gray-900 xl:grid-cols-3 xl:gap-4">
               ...
               <nav aria-label="Breadcrumb" class="text-right">
                     <ol class="flex items-center">
                        ...
                        <li class="group flex items-center">
                           ...
                           <a class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white max-w-[12rem] truncate" data-testid="flowbite-breadcrumb-item" href="{{ route('admin.users.index') }}">{{ $menu }}</a>
                        </li>
                        <li class="group flex items-center">
                           <svg stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 24 24" aria-hidden="true" class="mx-1 h-6 w-6 text-gray-400 group-first:hidden md:mx-2" data-testid="flowbite-breadcrumb-separator" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                           </svg>
                           <span class="flex items-center text-sm font-medium text-gray-500 dark:text-gray-400" data-testid="flowbite-breadcrumb-item">Add</span>
                        </li>
                     </ol>
               </nav>
            </div>
        ...
        <x-field-error field="title" type="alert" />
        <x-field-error field="body" type="alert" />
        <x-field-error field="slug" type="alert" />
        <x-field-error field="category_id" type="alert" />
        <x-field-error field="keywords" type="alert" />
        <x-field-error field="metadesc" type="alert" />
        <x-field-error field="image" type="alert" />
        <x-field-error field="publication" type="alert" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-[74%,26%] gap-4">
                            ...
                            <div class="xs:grid mb-4 h-auto max-w-4xl xl:mr-4 sm:grid-cols-2">
                                <div class="sm:col-span-2 mb-3">
                                    ...
                                    <input type="text" name="slug" id="slug" value="{{ old('slug') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:read-only:bg-gray-800 read-only:bg-gray-200 read-only:cursor-not-allowed" placeholder="Slug" readonly>
                                ...
                                <div class="sm:col-span-2 mb-3">
                                    ...
                                    <input type="text" name="keywords" id="keywords" value="{{ old('keywords') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Title">
                                </div>

                                <div class="sm:col-span-2 mb-3">
                                    <label for="metadesc" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Metadesc</label>
                                    <textarea id="metadesc" name="metadesc" rows="5" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Description">{{ old('metadesc') }}</textarea>
                                </div>
