<div class="col-span-2">
    ...
    <div class="w-full border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
        ...
        <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
            <label for="editor-wysiwyg" class="sr-only">Publish post</label>
            <div data-content="{{ $post->body }}" id="editor-wysiwyg" style="max-height: 702px; overflow: auto;" class="overflow-auto block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"></div>
            <!-- Hidden Input for Form Submission -->
            <input type="hidden" value="{{ $post->body }}" name="body" id="editor-content">
        </div>
    </div>
    {{-- <script>window.postContent = {!! json_encode($post->body) !!};</script> --}}
</div>